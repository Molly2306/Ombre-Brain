...
try:
    from bucket_scoring import (
        calc_topic_score as _ext_topic_score,
        calc_emotion_score as _ext_emotion_score,
        calc_time_score as _ext_time_score,
        calc_touch_score as _ext_touch_score,
    )
except ImportError:
    from .bucket_scoring import (  # type: ignore
        calc_topic_score as _ext_topic_score,
        calc_emotion_score as _ext_emotion_score,
        calc_time_score as _ext_time_score,
        calc_touch_score as _ext_touch_score,
...
class BucketManager:
    ...
    async def update(self, bucket_id: str, **kwargs) -> bool:
        ...
        for k in ("status", "type", "resolution_reason", "resolved_by",
                  ...
                  "source_tool", "grow_batch_id", "last_merged_by", "_pre_anchor_source_tool", "superseded_by"):
            if k in kwargs:
